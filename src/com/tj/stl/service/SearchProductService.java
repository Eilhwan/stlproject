...
public class SearchProductService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		String peName = request.getParameter("search-keyword");
		...
		if (peName != null) {
			list = pedao.searchPeList(startRow, endRow, peName);
			int pageCnt = (int) Math.ceil(((double)pedao.getUserProductCnt(peName)/PAGESIZE));
			...
			request.setAttribute("keyWord", peName);
			request.setAttribute("pageCnt", pageCnt);
			request.setAttribute("resultCnt", list.size());
			...
			request.setAttribute("resultmsg", "검색어를 입력하세요");
		}
