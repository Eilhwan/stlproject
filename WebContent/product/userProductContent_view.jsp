...
<body>
	...
	<div class="container overflow-hidden my-5">
		...
		<div>
			...
			<input type="hidden" value="${param.peCode }" name="peCode">
			<div class="float-left my-5">
				...
				<input type="number" name="productEA" id="productEA"><input type="submit" id="insertCart" class="btn btn-dark" value="장바구니 담기">
				<input type="button" class="btn btn-dark"value="바로구매 >" onclick="location.href='${conPath }/buy.do'">
				<p>문의 사항이 존재하다면? <a href="#">문의사항 바로가기</a></p>
			</div>
			</form>
		</div>
	</div>
